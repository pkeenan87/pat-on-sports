...
export const meta: PostMeta = {
  ...
  searchContent: "Pros Boutte looked really good. Diggs was decent and may improve as the year goes on. Coming off an ACL, that’s a strong Week 1. Pass rush was very good. Harold Landry can rush the passer. Cons Drake Maye’s mechanics looked bad. Run game was non-existent. Mental mistakes on the offensive line. Defense gave up ~10 plays of 20 yards or more. While we moved the ball, the offense still couldn’t score.",
