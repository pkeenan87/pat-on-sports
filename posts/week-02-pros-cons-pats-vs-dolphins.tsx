...
export const meta: PostMeta = {
  ...
  searchContent: "Pros The Patriots were able to run the ball and Stevenson looked great. The passing game was very efficient and pass protection looked good. Drake Maye’s athleticism is a weapon. On his TD, Judon had a clear path at full speed and Maye simply reversed field for the score—most QBs take a sack there. Through two weeks, the Patriots pass rush is up there with the best in the NFL. Landry and Williams are studs. Cons Pass coverage is very bad. I don’t know why we don’t play Dugger more, and we need Gonzalez back ASAP. Austin got torched. Linebackers have been rough and there may not be a clean solution. Spillane and Ellis have struggled. Mapu had a good INT but missed a tackle that nearly cost the game. Too many penalties, especially pre-snap penalties.",
