...
export const meta: PostMeta = {
  ...
  searchContent: "Pros Extremely efficient passing game. Drake Maye looked great. For the second time this year, special teams provided a big spark. Marcus Jones had two excellent returns, including one for a TD. No turnovers, much improved. Diggs had his first breakout game as a Patriot and looked great. Pass blocking was great even though Jared Wilson was out. Ben Brown filled in well. Spillane didn’t miss any tackles and Jack Gibbens seemed to provide an upgrade over Christian Ellis. Return of Christian Gonzalez made a huge impact on the pass defense. Cons Hard not to think “what if” after last week’s 5-turnover loss—this team could realistically be 3–1.",
