...
export const meta: PostMeta = {
  ...
  searchContent: "Pros We beat the Buffalo Bills in Buffalo. Doesn’t matter how it happened—this is a legit win. Drake Maye put together a game-winning drive in a big moment. This will do wonders for his confidence. Stefon Diggs is the man. He always seems to catch the ball when targeted and displayed incredible footwork on sideline catches. Christian Gonzalez changes the Patriots’ entire defense. His breakup on that last pass from Allen was an unsung hero play. Defensive line continues to be the strongest unit on the team. Barmore, Williams, and Landry got great pressure, and the blitzes were some of the best I’ve seen since Flores. Cons We lost Antonio Gibson for the year and Stevenson won’t stop fumbling. We will need to sign an RB, but replacing Gibson won’t be easy. Patriots offensive line continues to struggle picking up stunts. Onwenu got killed on one that should have resulted in a sack if Maye didn’t escape. Maye wasn’t always sharp against the blitz. The “book” on the Pats will be blitzes and stunts going forward; they have to overcome it. Missed opportunities and dumb penalties almost cost us the game.",
