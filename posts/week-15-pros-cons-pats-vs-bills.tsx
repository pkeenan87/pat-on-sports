...
export const meta: PostMeta = {
  ...
  searchContent: "Pros The Patriots showed their ceiling: when they’re at their best they can compete with anyone. Best run game of the year: Henderson was a weapon, Stevenson ran well, and Maye ran effectively in the red zone. Found part of the red zone solution: run Drake Maye. Offensive line performed decently; the extra OL package was extremely effective in the first half. Snowblower “bad gas” fix felt like a metaphor—maybe this was the Pats letting out their “bad gas.” Time will tell. Cons Worst collapse of the year. Losing when you’re up 21 is awful. Worst passing game of the year (especially the second half). Maye wasn’t in rhythm and Henry dropped a key pass. Defense gave up a run of TDs; run defense hasn’t been the same since Milton Williams got hurt. Vederian Lowe had another offsides penalty that kicked off a drive. Still watching him closely.",
